...
%%=====新增：图像上标注斜率=====
% 在图中空白位置标注收敛阶（斜率）
text(0.1,1e-1,'p_1=','Color','b','FontSize',10);
text(0.22,1e-1,sprintf('%.2f',p1(1)),'Color','b','FontSize',10);
text(0.1,1e-3,'p_2=','Color','r','FontSize',10);
text(0.22,1e-3,sprintf('%.2f',p2(1)),'Color','r','FontSize',10);
